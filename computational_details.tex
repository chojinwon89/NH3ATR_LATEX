...
\begin{equation}
  ...
  \tfrac{1}{2}\,\Delta H_f^{\,\mathrm{RuO_2}} \approx -1.59~\mathrm{eV},
  \label{eq:opoor}
\end{equation}
using the formation enthalpy obtained directly from our DFT total energies,
$\Delta H_f^{\,\mathrm{RuO_2}} = g^{\mathrm{bulk}}_{\mathrm{RuO_2}}
- g^{\mathrm{metal}}_{\mathrm{Ru}} - G_{\mathrm{O_2}}(0\,\mathrm{K}) = -3.18$~eV,
where the metallic reference $g^{\mathrm{metal}}_{\mathrm{Ru}}$ is the energy per
Ru atom of the relaxed hcp primitive cell; this DFT value agrees with the
experimental heat of formation ($-3.19$~eV) to within 15~meV. Because
$\Delta\mu_{\mathrm O}$
...
($-1.58$~eV) and the decomposition bound ($-1.59$~eV) nearly coincide, so the
...
\begin{figure*}[htbp]
  ...
  $\Delta\mu_{\mathrm O}=\tfrac{1}{2}\Delta H_f^{\,\mathrm{RuO_2}}\approx-1.59$~eV
